...
if os.path.isdir("versiculos"):
    print("diretorio biblia existe.")
else:
    os.mkdir("versiculos")
if os.path.isdir("versiculos\\"+versao):
    print("versiculos\\"+versao+" existe.")
else:
    os.mkdir("versiculos\\"+versao)

def getVersiculo(siglivro, cap, versiculos):
